...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void request(){
        ...
        final String url="http://ictchops.me.ke/job/getlocation.php?ids="+id;
            ...
            public void onResponse(JSONArray response) {
                ...
                for(int i=0;i<response.length();i++){
                    try {
                        ...
                        model.setCname(data.getString("cname"));
                        model.setJobname(data.getString("jobname"));
                        model.setContact(data.getString("contact"));
                        model.setLocation(data.getString("location"));
                        model.setSalary(data.getString("salary"));
                        model.setDescription(data.getString("description"));
                        //model.setImg(data.getString("location"));
